...
const Gradebooks = React.lazy(() => import('./pages/Gradebooks'))
const Studentinformationsystem = React.lazy(() => import('./pages/Studentinformationsystem'))
const Teacherprofilemanagement = React.lazy(() => import('./pages/Teacherprofilemanagement'))
...
const NAV_ITEMS = [
  { path: "/", label: "Home" },
  { path: "/studentdashboard", label: "Studentdashboard" },
  { path: "/teacherportal", label: "Teacherportal" },
  { path: "/admindashboard", label: "Admindashboard" },
  { path: "/attendancetracking", label: "Attendancetracking" },
  { path: "/gradebooks", label: "Gradebooks" },
  { path: "/studentinformationsystem", label: "Studentinformationsystem" },
  { path: "/teacherprofilemanagement", label: "Teacherprofilemanagement" },
  { path: "/coursemanagement", label: "Coursemanagement" },
  { path: "/feemanagement", label: "Feemanagement" },
  { path: "/reportgeneration", label: "Reportgeneration" },
    ...
    <footer className="bg-gray-900 text-gray-400 py-12 px-6 mt-auto">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center text-white text-xs font-black" style={{ backgroundColor: '#059669' }}>
                
              </div>
              <span className="text-white font-bold text-sm">Edify</span>
            </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} Edify. All rights reserved.</p>
    ...
    <BrowserRouter>
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1">
          ...
          <Route path="/teacherprofilemanagement" element={<Teacherprofilemanagement />} />
