...
const Filesharing = React.lazy(() => import('./pages/Filesharing'))
...
const NAV_ITEMS = [
  ...
  { path: "/privatechat", label: "Privatechat" },
  { path: "/groupchat", label: "Groupchat" },
  { path: "/userprofile", label: "Userprofile" },
  { path: "/filesharing", label: "Filesharing" },
    ...
    <footer className="bg-gray-900 text-gray-400 py-12 px-6 mt-auto">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} ChatFlow. All rights reserved.</p>
