...
const Userauthentication = React.lazy(() => import('./pages/Userauthentication'))
...
const NAV_ITEMS = [
  { path: "/", label: "Home" },
  { path: "/productcatalog", label: "Productcatalog" },
  { path: "/productdetails", label: "Productdetails" },
  { path: "/shoppingcart", label: "Shoppingcart" },
  { path: "/checkout", label: "Checkout" },
  { path: "/userauthentication", label: "Userauthentication" },
  { path: "/paymentintegration", label: "Paymentintegration" },
    ...
    <footer className="bg-gray-900 text-gray-400 py-12 px-6 mt-auto">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-7 h-7 rounded-lg flex items-center justify-center text-white text-xs font-black" style={{ backgroundColor: '#1d4ed8' }}>
                
              </div>
              <span className="text-white font-bold text-sm">ShopFlow</span>
            </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">© {new Date().getFullYear()} ShopFlow. All rights reserved.</p>
