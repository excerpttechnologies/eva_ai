  ...
  return (
    <div className="bg-gradient-to-r from-blue-500 to-purple-500 min-h-screen">
      <header className="py-20 px-6 bg-white shadow-md rounded-xl md:grid-cols-3 grid gap-8">
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full shadow-md md:col-span-2" type="button">
          CTA Button
        </button>
      </header>
      ...
      <footer className="py-16 px-6 bg-gray-100 text-center border-t border-gray-300">
        <p>Footer Section</p>
      </footer>
    </div>
  );
